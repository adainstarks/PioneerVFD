    ...
    root.innerHTML = `
      <div class="pvfd-faceplate">
        ...
        <div style="display:flex;align-items:center;gap:12px;justify-content:flex-end;">
          ...
          <div class="pvfd-eject-cluster" style="display:flex;align-items:center;gap:5px;padding-left:2px;">
            <span class="pvfd-eject-label" style="color:#d8dce0;font-size:10px;font-weight:700;letter-spacing:0.5px;">EJECT</span>
  ...
  function getPvfdCinemaEl() {
    ...
    pvfdCinemaEl.innerHTML = `
      ...
      <div class="pvfd-cinema-topstrip" aria-hidden="true">
        <span class="pvfd-cinema-topstrip-side">EEQ · MOSFET 50W&times;4</span>
