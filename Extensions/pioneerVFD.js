...
//no synthetic fallback
  ...
  const LYRICS_SCOPE_SELECTOR = "[data-testid*='lyrics' i], [class*='lyrics-lyrics' i], [class*='LyricsLyrics' i], [class*='lyricsPage' i], [class*='LyricsPage' i]";
  ...
  function reconcileLyricsSyncButtons(root = document) {
    ...
    collectButtons(root).forEach((button) => {
      ...
      if (label === "Sync" && !patchedLyricsSyncButtons.has(button)) {
        patchedLyricsSyncButtons.add(button);
