...
**v4.0.6:** truer blue/indigo tints ([#28](https://github.com/adainstarks/PioneerVFD/issues/28)), the first audio-reactive OEL clip (`GAUGES`), the `PIONEERVFD` hero clip, and a leaner runtime.
