...
**v4.0.7:** **Spicy-Lyrics compatibility**, truer violet/blue/indigo tints ([#28](https://github.com/adainstarks/PioneerVFD/issues/28)), the first audio-reactive OEL clip (`GAUGES`), the `PIONEERVFD` clip, and a leaner runtime.
